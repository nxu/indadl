...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_tabs_component__ = __webpack_require__(11);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_tabs_component___default.a);
...
var app = new Vue({
    ...
    methods: {
        getSource: function getSource() {
            ...
            axios.post('/url', { url: this.sourceUrl }).then(function (response) {
                _this.sourceUrl = '';
                _this.files = response.data.resolutions;
            }).catch(function () {
                _this.error = 'Kérlek, adj meg egy működő Indavideó URL-t';
            }).then(function () {
